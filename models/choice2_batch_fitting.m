...
function choice2_batch_fitting(u_alphat,u_alphan,u_tau)
    %% load
    sdata     = struct();
    models    = struct();
    numbers   = struct();
    ...
    if isempty(greed_bic) || ...
       ~isfield(numbers,'choice2')   || ...
       ~isfield(numbers.choice2,'u_alphat')        || ~isfield(numbers.choice2,'u_alphan')        || ~isfield(numbers.choice2,'u_tau')     || ...
       ~isequal(u_alphat,numbers.choice2.u_alphat) || ~isequal(u_alphan,numbers.choice2.u_alphan) || ~isequal(u_tau,numbers.choice2.u_tau)
        ...
        parfor i_loop = 1:nb_loop
            [   new_keys{i_loop} ,      ...
                new_vals{i_loop} ] =    ...
                                     choice2_batch_fitting_par( u_subject,  ...
                                                            u_novel, ...
                                                            human, ...
                                                            sdata, ...
                                                            mdata, ...
        ...
        %% save
        save('data/models_choice2.mat','-append','mbic','greed_bic');
