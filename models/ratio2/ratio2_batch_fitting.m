...
function ratio2_batch_fitting(u_alpham,u_alphar,u_tau)
    ...
    if isempty(greed_bic) || ...
       ~isfield(numbers,'ratio2')   || ...
       ~isfield(numbers.ratio2,'u_alpham')        || ~isfield(numbers.ratio2,'u_alphar')        || ~isfield(numbers.ratio2,'u_tau')     || ...
       ~isequal(u_alpham,numbers.ratio2.u_alpham) || ~isequal(u_alphar,numbers.ratio2.u_alphar) || ~isequal(u_tau,numbers.ratio2.u_tau)
        ...
        %% save
        save('data/models_ratio2.mat','-append','mbic','greed_bic');
