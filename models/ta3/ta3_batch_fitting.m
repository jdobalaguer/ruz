...
function ta3_batch_fitting(u_alpham,u_alphar,u_tau)
    %% load
    sdata     = struct();
    models    = struct();
    numbers   = struct();
    ...
    parfor i_loop = 1:nb_loop
        ...
        [   new_keys{i_loop} ,      ...
            new_vals{i_loop} ] =    ...
                                 ta3_batch_fitting_par(   u_subject,  ...
                                                            u_novel, ...
                                                            human, ...
                                                            sdata, ...
                                                            mdata, ...
    ...
    %% save
    save('data/models_ta3.mat','-append','mbic','greed_bic');
