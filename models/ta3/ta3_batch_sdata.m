...
function ta3_batch_sdata(u_alpham,u_alphar,u_tau)
    %% load
    sdata     = struct();
    models    = struct();
    numbers   = struct();
    ...
    greed_bic = [];
    load('data/sdata.mat');
    load('data/models_ta3.mat','mdata','greed_bic');
    ...
    for i_novel   = 1:nb_novel
        ...
        % values
        model = mdata(key);
        models.ta3.choice(ii_frame)  = model.choice(ii_frame);
        models.ta3.correct(ii_frame) = model.correct(ii_frame);
