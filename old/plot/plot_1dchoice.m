...
%% get values
choi = nan(numbers.nb_novelties, numbers.nb_subjects , numbers.nb_propangs);
...
for i_novelty = 1:numbers.nb_novelties
    for i_subject = 1:numbers.nb_subjects
        ...
        for i_propang = 1:numbers.nb_propangs
            ...
            % get value
            if ~isempty(i_thresh)
                choi(i_novelty,i_subject,i_propang) = mean(sdata.modch(subject,novelty,i_propabs,i_propang,i_thresh,:));
            end
        end
    end
end
